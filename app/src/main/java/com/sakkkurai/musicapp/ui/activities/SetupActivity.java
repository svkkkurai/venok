...
public class SetupActivity extends AppCompatActivity {
    ...
    private void showPermissionExplanationDialog(String permission, int requestCode) {
        new MaterialAlertDialogBuilder(SetupActivity.this)
                ...
                .setPositiveButton(R.string.permission_grant, (dialogInterface, i) -> ActivityCompat.requestPermissions(SetupActivity.this, new String[]{permission}, requestCode))
                .setNegativeButton(R.string.permission_no, (dialog, which) -> dialog.dismiss())
                .show();
    }
